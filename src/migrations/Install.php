        ...
        if ($tableSchema === null) {
            ...
            $this->createTable(
                ...
                [
                    ...
                    'dropdownType' => $this->string(50)->notNull()->defaultValue('static'),
                    'dynamicSource' => $this->string(50)->null(),
                    'dynamicSourceId' => $this->integer(11)->null(),
                    'maxLevel' => $this->integer(11)->notNull()->defaultValue(1),
                    'dynamicSettings' => $this->text()->null(),
                    'dateCreated' => $this->dateTime()->notNull(),
                    'dateUpdated' => $this->dateTime()->notNull(),
                    'uid' => $this->uid(),
                ]
